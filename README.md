...
Pricing: Completely free for campus-based businesses 
...
## Target Audience
- Student-run businesses (food, snacks, accesories, print services)
...
| Instant receipts | Build trust with customers |
